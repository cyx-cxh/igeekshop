    ...
    window.onload=function(){
    	var img=document.getElementById("vcode");
    		...
    		{ var date=new Date().getTime();
    			  img.src="${pageContext.request.contextPath }/checkcode?time="+ date;
    		}
    	}
    </script>
</head>
				...
				<div
					...
					<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/user?method=login">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath }/checkcode" id="vcode"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									...
									<input
										type="checkbox" name="remember" value="yes" checked="checked"> 记住用户名
									</label>
								</div>
							</div>
						</div>
