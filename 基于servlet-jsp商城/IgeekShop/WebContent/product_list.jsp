...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pd.list }" var="pro">
		<div class="col-md-2" style="text-align: center;height: 200px;margin: 20px;">
			<a href="${pageContext.request.contextPath }/product?method=productinfo&pid=${pro.pid }&cid=${cid}&currentPage=${pd.currentPage}"> <img src="${pageContext.request.contextPath }/${pro.pimage }"
				width="170" height="170" style="display: inline-block;">
			</a>
			<p>
			<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${pro.pid }&cid=${cid}&currentPage=${pd.currentPage} " style='color: green'>${pro.pname }</a>
			</p>
			<p>
	...
	<nav aria-label="Page navigation">
			...
			<c:if test="${pd.currentPage==page }">
					<li class="active">
 			<a 	href="${pageContext.request.contextPath}/product?method=productList&currentPage=${page }&rows=15&pname=${condition.pname[0]}
 			"
						>${page }</a>
					</li>
			</c:if>
