...
<html>
	...
	<c:if test="${empty cart.cartItems }">
							<img src="${pageContext.request.contextPath }/images/cart1.gif ">
							<h2><a href="${pageContext.request.contextPath }/product?method=IndexServlet">返回首页</a></h2>
							</c:if>
					...
					<table class="table table-bordered">
						<tbody>
							...
							<td width="60" width="40%">
								...
								<td>
									<a href="javascript:delFromCart('${cartItem.key}')" class="delete">删除</a>
								</td>
								</tr>
