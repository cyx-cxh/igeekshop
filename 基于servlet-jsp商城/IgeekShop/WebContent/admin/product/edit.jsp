			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot">
							<option value="1"<c:if test="${pro.is_hot==1 }">selected</c:if>>是</option>
							<option value="0"<c:if test="${pro.is_hot==0 }">selected</c:if>>否</option>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						...
						<option value="${cate.cid }" <c:if 
						test="${pro.cid==cate.cid }"> selected="selected" 
						</c:if>>
						${cate.cname }
						</option>
						</c:forEach>
				...
				<tr>
					...
					<input type="hidden" name="pflag"  value="${pro.pflag }"/>
					</td>
				</tr>
				<tr>
