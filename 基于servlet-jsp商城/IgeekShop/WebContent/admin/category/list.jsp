...
function deletecategory(cid){
	if(confirm("确定删除？")){
        ...
        location.href="${pageContext.request.contextPath}/deleteCategoryByid?cid="+cid;
        }
	}
					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/findCategoryById?cid=${category.cid }">
										<img
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="javascript:deletecategory('${category.cid}')">
